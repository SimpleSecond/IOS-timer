...
- (void)setupNav
{
    self.navigationItem.title = @"CADisplayLink";
}
...
- (void)startTimer
{
    ...
    self.displayLink = [CADisplayLink displayLinkWithTarget:self selector:@selector(updateTimerInfo)];
    // self.displayLink.duration;
    self.displayLink.preferredFramesPerSecond = 10; // 每秒调用10次
